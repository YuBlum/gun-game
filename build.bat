...
set OUT=game
set SRCS=..\src\main.cpp ..\src\window.cpp ..\src\renderer.cpp ..\src\math.cpp ..\src\animator.cpp ..\src\game.cpp ..\src\player.cpp ..\src\mover.cpp ..\src\map.cpp ..\src\collider.cpp ..\src\bullet.cpp
